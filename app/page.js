 ...
 * Minimal patch:
 *  - Fix ESLint: escape quotes in Hero scripture
 *  - Replace <img> with next/image
 *  - Add responsive media queries + subtle effects (hover, focus, motion-safe)
 *  - Correct institute typo in Timeline
 */
  ...
  return (
    <section id="hero" style={wrap}>
      <div style={{ ...containerStyle }}>
        ...
        <div style={ctaRow}>
          <a className="btn btn-gold" href={`${mail}?subject=Invite%20to%20Speak%20%E2%80%94%20MOUNT%20ZION%20Prayer%20Ministries`} style={btnGold}>Invite to Speak</a>
          <a className="btn btn-outline" href={`${mail}?subject=Book%20a%20Finance%20Consult%20%E2%80%94%20MZPM`} style={btnOutlineLight}>Book a Finance Consult</a>
          <a className="btn btn-muted" href="https://www.youtube.com/@kemiakinsipe4993" target="_blank" rel="noreferrer" style={btnMuted}>▶ Watch on YouTube</a>
        </div>
        {/* ✅ Escaped quotes for ESLint */}
        <p style={small}>&ldquo;I was created to make His praise glorious.&rdquo;</p>
      </div>
    </section>
  );
}
  ...
  return (
    <section id="about" style={sectionStyle}>
      <div style={containerStyle}>
        ...
        <div className="grid-about" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, marginTop: 16 }}>
          <div className="glass" style={{ ...cardStyle, display: "grid", gridTemplateColumns: "96px 1fr", gap: 12, alignItems: "center" }}>
            {/* ✅ Use next/image */}
            <Image src="/images/images7.jpg" alt="Adekemi Akinsipe portrait" width={96} height={96} style={{ borderRadius: 999, objectFit: "cover" }} />
            <div>
              ...
              <p style={{ marginTop: 12 }}>&ldquo;My mission is to proclaim Christ and equip leaders to steward people and resources with integrity.&rdquo;</p>
            </div>
          </div>
          <ul className="glass" style={{ ...cardStyle, listStyle: "none", margin: 0 }}>
  ...
  return (
    <section id="ministry" style={{ ...sectionStyle, background: "#fff" }}>
      <div style={containerStyle}>
        ...
        <div className="grid-ministry" style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 16, marginTop: 16 }}>
          {items.map((it) => (
            <div key={it.title} className="glass card" style={cardStyle}>
              ...
              <a className="btn btn-gold" href={`${mail}?subject=Booking%20Request%20%E2%80%94%20${encodeURIComponent(it.title)}`} style={{ ...btnGold, marginTop: 12 }}>Request Booking</a>
            </div>
          ))}
        </div>
      </div>
  ...
  return (
    <section id="consulting" style={{ ...sectionStyle, background: TOKENS.soft }}>
      <div style={containerStyle}>
        ...
        <div className="grid-consulting" style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 16, marginTop: 16 }}>
          {values.map((v) => (
        ...
        <div className="glass" style={{ ...cardStyle, marginTop: 16, display: "grid", gap: 12 }}>
          ...
          <a className="btn btn-gold" href={`${mail}?subject=Consultation%20Request%20%E2%80%94%20MZPM&body=Please%20include%20your%20organization%2C%20timeline%2C%20and%20scope.`} style={{ ...btnGold, width: 240 }}>Email Your Request</a>
        </div>
      </div>
    </section>
  );
  ...
  return (
    <section id="music" style={sectionStyle}>
      <div style={containerStyle}>
        ...
        <div className="grid-music" style={{ display: "grid", gridTemplateColumns: "1.3fr 1fr", gap: 16, marginTop: 16 }}>
          <div className="glass" style={{ ...cardStyle, padding: 0, overflow: "hidden", aspectRatio: "16/9" }}>
            <iframe
          ...
          <div style={{ display: "grid", gap: 8 }}>
            <a className="glass" href="https://www.youtube.com/@kemiakinsipe4993" target="_blank" rel="noreferrer" style={{ ...cardStyle, textDecoration: "none", color: TOKENS.navy }}>▶ Songs</a>
            ...
            <a className="glass" href="https://www.youtube.com/@MountZionPrayerMinistryI-fz9ls/videos" target="_blank" rel="noreferrer" style={{ ...cardStyle, textDecoration: "none", color: TOKENS.navy }}>▶ Ministry at This Church</a>
            <a className="btn btn-gold" href="https://www.youtube.com/@kemiakinsipe4993" target="_blank" rel="noreferrer" style={{ ...btnGold, width: 220 }}>View Channel</a>
          </div>
        </div>
      </div>
    </section>
...
function Timeline() {
  const items = [
    ...
    { year: "2014", title: "ACA/CPA", where: "Institute of Chartered Accountants" }, // ✅ corrected typo
  ...
  return (
    <section style={sectionStyle}>
      <div style={containerStyle}>
        ...
        <div className="grid-timeline" style={{ marginTop: 12, display: "grid", gap: 10 }}>
          {items.map((i) => (
            <div key={i.year} className="glass" style={{ ...cardStyle, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
      ...
      <div style={containerStyle}>
        ...
        <div className="grid-contact" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, marginTop: 16 }}>
          <div className="glass" style={{ ...cardStyle, display: "grid", gap: 10 }}>
            ...
            <a className="btn btn-gold" href={`${mail}?subject=Ministry%20Booking%20Request%20%E2%80%94%20MZPM&body=Please%20include%20event%20date%2C%20location%2C%20audience%20size%20and%20details.`} style={{ ...btnGold, width: 260 }}>Email Booking</a>
          </div>
          <div className="glass" style={{ ...cardStyle, display: "grid", gap: 10 }}>
            ...
            <a className="btn btn-gold" href={`${mail}?subject=Consulting%20Inquiry%20%E2%80%94%20Finance%20Advisory&body=Organization%3A%0AScope%3A%0ABudget%3A%0ATimeline%3A`} style={{ ...btnGold, width: 260 }}>Email Inquiry</a>
          </div>
        </div>
      </div>
    </section>
...
function Footer() {
  return (
    <footer style={{ background: TOKENS.navy, color: "#fff", padding: "48px 0" }}>
      <div className="grid-footer" style={{ ...containerStyle, display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 16, fontSize: 14 }}>
        <div>
        ...
        <div>
          ...
          <p style={{ margin: 0 }}><a href="https://www.instagram.com/adekemiakinsipe/" style={{ color: "#fff", textDecoration: "none" }}>instagram</a></p>
        </div>
      </div>
      <div style={{ ...containerStyle, marginTop: 16, fontSize: 12, opacity: 0.8 }}>© {new Date().getFullYear()} Kemmy Muzik International. All rights reserved.</div>
    </footer>
  );
}
...
function WhatsAppButton() {
  ...
  return (
    <a className="fab-whatsapp" href="https://wa.me/2348160368444" aria-label="Chat on WhatsApp" target="_blank" rel="noreferrer" style={wrap}>
...
export default function Home() {
  return (
    <div style={{ background: TOKENS.ivory, color: TOKENS.slate, fontFamily: "Inter, system-ui, -apple-system, Segoe UI, Roboto, Arial" }}>
      ...
      {/* ---------- Responsive & Effects (global) ---------- */}
      <style jsx global>{`
        /* Responsive grids */
        @media (max-width: 1024px) {
          .grid-consulting { grid-template-columns: repeat(2, 1fr) !important; }
          .grid-ministry   { grid-template-columns: repeat(2, 1fr) !important; }
          .grid-footer     { grid-template-columns: repeat(2, 1fr) !important; }
          .grid-music      { grid-template-columns: 1fr !important; }
        }
        @media (max-width: 640px) {
          #hero h1 { font-size: 32px !important; line-height: 1.2 !important; }
          .grid-about     { grid-template-columns: 1fr !important; }
          .grid-consulting{ grid-template-columns: 1fr !important; }
          .grid-ministry  { grid-template-columns: 1fr !important; }
        ...
        @media (prefers-reduced-motion: no-preference) {
          .glass, .btn { transition: transform .25s ease, box-shadow .25s ease, background-color .25s ease, color .25s ease; }
          .glass:hover { transform: translateY(-2px); box-shadow: 0 14px 40px rgba(12,27,42,0.18); }
          .btn:hover   { transform: translateY(-1px); box-shadow: 0 10px 28px rgba(12,27,42,0.16); }
        }
        .btn:focus-visible, .glass:focus-within {
          outline: 2px solid ${TOKENS.gold};
          outline-offset: 2px;
        }

        /* WhatsApp FAB slight bob on hover (motion-safe) */
        @media (prefers-reduced-motion: no-preference) {
          .fab-whatsapp { transition: transform .25s ease; }
